...
public class Colas{
	...
	public static void main(String args[])
	{
		try
		{
			...
			ColaHeap<Paciente> pacientes = new ColaHeap<Paciente>(temp);
	...
	private static void AnadirPaciente(ColaHeap<Paciente> pacientes)
	{
	...
	private static int Menu(ColaHeap<Paciente> pacientes) throws Exception
	{
		try
		{			
