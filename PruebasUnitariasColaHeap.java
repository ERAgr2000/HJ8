...
class PruebasUnitariasColaHeap {
	...
	public void testRetirar() throws Exception 
	{
		...
		ColaHeap<Paciente> cola = new ColaHeap<Paciente>(temp);
	...
	public void testInsertar() throws Exception 
	{
		...
		ColaHeap<Paciente> esperadoCola = new ColaHeap<Paciente>(esperadoTemp);
		ColaHeap<Paciente> resultadoCola = new ColaHeap<Paciente>(resultadoTemp);
